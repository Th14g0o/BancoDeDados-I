...
(data_hora, tipo, nome_id_usuario, id_post)
VALUES('2023-09-26', 1, 'LatinoAmericano',1),
	  ('2023-09-26', 4, 'Welli', 1),
	  ('2023-09-26', 1, 'JoaoDosLanche', 1),
	  ('2023-09-26', 2, 'Cleyton', 2),
	  ('2023-09-26', 9, 'Th14g0o', 3);
